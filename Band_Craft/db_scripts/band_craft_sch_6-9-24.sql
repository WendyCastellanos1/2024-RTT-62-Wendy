...
CREATE TABLE `band_details` (
  ...
  `member_talent_id` varchar(45) COLLATE utf8mb3_bin NOT NULL,
...
CREATE TABLE `bands` (
  `id` int NOT NULL AUTO_INCREMENT,
  `event_type_id` varchar(45) COLLATE utf8mb3_bin NOT NULL,
  `is_active` int NOT NULL,
  `is_single_use` int NOT NULL,
...
CREATE TABLE `events` (
  ...
  `contact_phone_alt` varchar(45) COLLATE utf8mb3_bin DEFAULT NULL,
  `contact_phone_cell` varchar(45) COLLATE utf8mb3_bin NOT NULL,
  `date_created` datetime NOT NULL,
  `date_updated` datetime DEFAULT NULL,
  `comments` varchar(1000) COLLATE utf8mb3_bin DEFAULT NULL,
  `last_update_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
...
CREATE TABLE `member_event_types` (
  ...
  `event_type_id` int NOT NULL,
  `will_volunteer` int DEFAULT NULL,
  `min_fee_required` decimal(10,0) DEFAULT NULL,
  `comments` varchar(255) COLLATE utf8mb3_bin DEFAULT NULL,
  `date_created` datetime NOT NULL,
  `date_updated` datetime DEFAULT NULL,
  `updated_by_id` int DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `min_fee_required_UNIQUE` (`min_fee_required`),
  UNIQUE KEY `will_volunteer_UNIQUE` (`will_volunteer`)
...
CREATE TABLE `members` (
  ...
  `profile_image_url` varchar(60) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
...
CREATE TABLE `talents` (
  ...
  `url_photo1` varchar(60) COLLATE utf8mb3_bin DEFAULT NULL,
  `url_photo2` varchar(60) COLLATE utf8mb3_bin DEFAULT NULL,
  `is_active` tinyint NOT NULL DEFAULT '0',
  `date_created` datetime NOT NULL,
  `date_updated` datetime DEFAULT NULL,
...
-- Dump completed on 2024-06-09 15:09:25
